...
public class SqlResetVariableConverter implements SqlNodeConverter<SqlResetVariable> {
    ...
    @Override
    public Operation convertSqlNode(SqlResetVariable sqlResetVariable, ConvertContext context) {
        return new ResetVariableOperation(sqlResetVariable.getKeyString());
    }
}
