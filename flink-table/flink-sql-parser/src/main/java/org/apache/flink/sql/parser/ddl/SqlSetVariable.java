...
/** SQL call for "SET_VAR" and "SET_VAR" 'key' = 'value'. */
@Internal
public class SqlSetVariable extends SqlCall {

    public static final SqlSpecialOperator OPERATOR =
            new SqlSpecialOperator("SET_VAR", SqlKind.OTHER);

    @Nullable private final SqlNode key;
    @Nullable private final SqlNode value;

    public SqlSetVariable(SqlParserPos pos, SqlNode key, SqlNode value) {
        super(pos);
        this.key = Objects.requireNonNull(key, "key cannot be null");
        this.value = Objects.requireNonNull(value, "value cannot be null");
    }

    public SqlSetVariable(SqlParserPos pos) {
        super(pos);
        this.key = null;
        this.value = null;
    }
